...
//         Marrying contemporary design with original features and heirloom pieces 
//         remaining from the rich colonial history of the building, 
...
function HotelCard({imageUrl, title, subtitle, description,}) {
  return (
